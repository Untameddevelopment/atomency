...
class VSEPRPhysics {
    ...
    _buildIdealDirections() {
        ...
        // --- 4 electron domains ---
        // Tetrahedral 2D projection: top, bottom-left, bottom-right, center-front
        // 4-0: Tetrahedral, 109.5° (2D projection angles approx)
        dirs['4-0'] = fromAngles([90, 215, 325, 270]);
        ...
        dirs['2-2'] = fromAngles([270 - halfBent, 270 + halfBent, 75, 105]);
